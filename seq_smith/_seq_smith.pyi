...
class AlignmentStats:
    ...
    """
    @property
    def num_exact_matches(self) -> builtins.int: ...
    @property
    def num_positive_mismatches(self) -> builtins.int: ...
    @property
    def num_negative_mismatches(self) -> builtins.int: ...
    @property
    def num_a_gaps(self) -> builtins.int: ...
    @property
    def num_b_gaps(self) -> builtins.int: ...
...
def global_align_many(seqa: bytes, seqbs: typing.Sequence[bytes], score_matrix: numpy.typing.NDArray[numpy.int32], gap_open: builtins.int, gap_extend: builtins.int, num_threads: typing.Optional[builtins.int] = None) -> builtins.list[Alignment]:
    r"""
...
def local_align_many(seqa: bytes, seqbs: typing.Sequence[bytes], score_matrix: numpy.typing.NDArray[numpy.int32], gap_open: builtins.int, gap_extend: builtins.int, num_threads: typing.Optional[builtins.int] = None) -> builtins.list[Alignment]:
    r"""
...
def local_global_align_many(seqa: bytes, seqbs: typing.Sequence[bytes], score_matrix: numpy.typing.NDArray[numpy.int32], gap_open: builtins.int, gap_extend: builtins.int, num_threads: typing.Optional[builtins.int] = None) -> builtins.list[Alignment]:
    r"""
...
def overlap_align_many(seqa: bytes, seqbs: typing.Sequence[bytes], score_matrix: numpy.typing.NDArray[numpy.int32], gap_open: builtins.int, gap_extend: builtins.int, num_threads: typing.Optional[builtins.int] = None) -> builtins.list[Alignment]:
    r"""
